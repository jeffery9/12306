...
# 🚀 8. 进阶：5 千万级超高并发极限扩容指北 (50M QPS/TPS Horizon)

当并发达到 50,000,000 QPS 的史诗级海量狂澜时，单机与小集群终将面临物理算力的绝对瓶颈。基于本项目经过完美死锁剥离的微观理论内核，我们草拟了进军千万级的宏观扩展路线图：

👉 **[点击阅读：《12306 性能基线报告与 5千万级 (50M CQS) 极限容量演进规划》](./docs/12306_千万级超高并发容量规划与架构演进方案.md)**
👉 **[点击阅读：《12306 高并发票务系统 — 生产级容量估算与硬件选型白皮书》](./docs/12306_高并发系统容量估算与硬件选型白皮书.md)**
👉 **[点击阅读：《12306 高并发票务系统 — 运行成本估算与 TCO 财务预算白皮书》](./docs/12306_高并发系统运行成本估算与财务预算白皮书.md)**

这些设计与白皮书详述了如何通过 **“CDN 智能边缘预热”、“排队削峰网关”、“MySQL 二百五十六等份细胞化分表（Cellular Sharding）” 以及 “CDC 增量解耦”** 的物理堆叠，配合高主频 Redis 节点、256 主从 MySQL SSD 磁盘矩阵、跨中心光环线的精确配置计算，以及云原生 HPA/KEDA 自动弹性缩容的年度降本 ROI 核算，在代码微观骨架不变的前提下，构建出承载地狱级峰值且极具财务性价比的数字长城。
