...
| **Spine Mgmt Ports** | `192.168.100.1` - `192.168.100.4` | Spine 交换机背面专有 10/100/1000M 物理 Mgmt 口。<br>（🚀 生产 2-Spine 仅占用 `.1` - `.2`；📋 48-Leaf 模式下完全启用 `.1` - `.4`） |
| **Leaf Mgmt Ports** | `192.168.100.11` - `192.168.100.58` | Leaf 交换机背面专有 10/100/1000M 物理 Mgmt 口。<br>（🚀 生产 8-Leaf 仅占用 `.11` - `.18`；📋 48-Leaf 模式下完全启用 `.11` - `.58`） |
